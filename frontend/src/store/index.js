...
export default createStore({
  ...
  countries: [
    ...
    { countryname: "Afghanistan", countryval: "AF" },
    { countryname: "Albania", countryval: "AL" },
    { countryname: "Algeria", countryval: "DZ" },
    { countryname: "American Samoa", countryval: "AS" },
    { countryname: "Andorra", countryval: "AD" },
    { countryname: "Angola", countryval: "AO" },
    { countryname: "Anguilla", countryval: "AI" },
    { countryname: "Antarctica", countryval: "AQ" },
    { countryname: "Antigua and Barbuda", countryval: "AG" },
    { countryname: "Argentina", countryval: "AR" },
    { countryname: "Armenia", countryval: "AM" },
    { countryname: "Aruba", countryval: "AW" },
    { countryname: "Australia", countryval: "AU" },
    { countryname: "Austria", countryval: "AT" },
    { countryname: "Azerbaijan", countryval: "AZ" },
    { countryname: "Bahamas", countryval: "BS" },
    { countryname: "Bahrain", countryval: "BH" },
    { countryname: "Bangladesh", countryval: "BD" },
    { countryname: "Barbados", countryval: "BB" },
    { countryname: "Belarus", countryval: "BY" },
    { countryname: "Belgium", countryval: "BE" },
    { countryname: "Belize", countryval: "BZ" },
    { countryname: "Benin", countryval: "BJ" },
    { countryname: "Bermuda", countryval: "BM" },
    { countryname: "Bhutan", countryval: "BT" },
    { countryname: "Bolivia", countryval: "BO" },
    { countryname: "Bonaire, Sint Eustatius and Saba", countryval: "BQ" },
    { countryname: "Bosnia and Herzegovina", countryval: "BA" },
    { countryname: "Botswana", countryval: "BW" },
    { countryname: "Bouvet Island", countryval: "BV" },
    { countryname: "Brazil", countryval: "BR" },
    { countryname: "British Indian Ocean Territory", countryval: "IO" },
    { countryname: "Brunei Darussalam", countryval: "BN" },
    { countryname: "Bulgaria", countryval: "BG" },
    { countryname: "Burkina Faso", countryval: "BF" },
    { countryname: "Burundi", countryval: "BI" },
    { countryname: "Cabo Verde", countryval: "CV" },
    { countryname: "Cambodia", countryval: "KH" },
    { countryname: "Cameroon", countryval: "CM" },
    { countryname: "Canada", countryval: "CA" },
    { countryname: "Cayman Islands", countryval: "KY" },
    { countryname: "Central African Republic", countryval: "CF" },
    { countryname: "Chad", countryval: "TD" },
    { countryname: "Chile", countryval: "CL" },
    { countryname: "China (中国)", countryval: "CN" },
    { countryname: "Christmas Island", countryval: "CX" },
    { countryname: "Cocos (Keeling) Islands", countryval: "CC" },
    { countryname: "Colombia", countryval: "CO" },
    { countryname: "Comoros", countryval: "KM" },
    { countryname: "Congo", countryval: "CG" },
    { countryname: "Congo (Democratic Republic)", countryval: "CD" },
    { countryname: "Cook Islands", countryval: "CK" },
    { countryname: "Costa Rica", countryval: "CR" },
    { countryname: "Croatia", countryval: "HR" },
    { countryname: "Cuba", countryval: "CU" },
    { countryname: "Curaçao", countryval: "CW" },
    { countryname: "Cyprus", countryval: "CY" },
    { countryname: "Czech Republic", countryval: "CZ" },
    { countryname: "Denmark", countryval: "DK" },
    { countryname: "Djibouti", countryval: "DJ" },
    { countryname: "Dominica", countryval: "DM" },
    { countryname: "Dominican Republic", countryval: "DO" },
    { countryname: "Ecuador", countryval: "EC" },
    { countryname: "Egypt", countryval: "EG" },
    { countryname: "El Salvador", countryval: "SV" },
    { countryname: "Equatorial Guinea", countryval: "GQ" },
    { countryname: "Eritrea", countryval: "ER" },
    { countryname: "Estonia", countryval: "EE" },
    { countryname: "Eswatini", countryval: "SZ" },
    { countryname: "Ethiopia", countryval: "ET" },
    { countryname: "Falkland Islands", countryval: "FK" },
    { countryname: "Faroe Islands", countryval: "FO" },
    { countryname: "Fiji", countryval: "FJ" },
    { countryname: "Finland", countryval: "FI" },
    { countryname: "France", countryval: "FR" },
    { countryname: "French Guiana", countryval: "GF" },
    { countryname: "French Polynesia", countryval: "PF" },
    { countryname: "French Southern Territories", countryval: "TF" },
    { countryname: "Gabon", countryval: "GA" },
    { countryname: "Gambia", countryval: "GM" },
    { countryname: "Georgia", countryval: "GE" },
    { countryname: "Germany", countryval: "DE" },
    { countryname: "Ghana", countryval: "GH" },
    { countryname: "Gibraltar", countryval: "GI" },
    { countryname: "Greece", countryval: "GR" },
    { countryname: "Greenland", countryval: "GL" },
    { countryname: "Grenada", countryval: "GD" },
    { countryname: "Guadeloupe", countryval: "GP" },
    { countryname: "Guam", countryval: "GU" },
    { countryname: "Guatemala", countryval: "GT" },
    { countryname: "Guernsey", countryval: "GG" },
    { countryname: "Guinea", countryval: "GN" },
    { countryname: "Guinea-Bissau", countryval: "GW" },
    { countryname: "Guyana", countryval: "GY" },
    { countryname: "Haiti", countryval: "HT" },
    { countryname: "Heard Island and McDonald Islands", countryval: "HM" },
    { countryname: "Holy See", countryval: "VA" },
    { countryname: "Honduras", countryval: "HN" },
    { countryname: "Hong Kong (香港)", countryval: "HK" },
    { countryname: "Hungary", countryval: "HU" },
    { countryname: "Iceland", countryval: "IS" },
    { countryname: "India", countryval: "IN" },
    { countryname: "Indonesia", countryval: "ID" },
    { countryname: "Iran", countryval: "IR" },
    { countryname: "Iraq", countryval: "IQ" },
    { countryname: "Ireland", countryval: "IE" },
    { countryname: "Isle of Man", countryval: "IM" },
    { countryname: "Israel", countryval: "IL" },
    { countryname: "Italy", countryval: "IT" },
    { countryname: "Jamaica", countryval: "JM" },
    { countryname: "日本 (Japan)", countryval: "JP" },
    { countryname: "Jersey", countryval: "JE" },
    { countryname: "Jordan", countryval: "JO" },
    { countryname: "Kazakhstan", countryval: "KZ" },
    { countryname: "Kenya", countryval: "KE" },
    { countryname: "Kiribati", countryval: "KI" },
    { countryname: "Korea (North)", countryval: "KP" },
    { countryname: "Korea (South)", countryval: "KR" },
    { countryname: "Kuwait", countryval: "KW" },
    { countryname: "Kyrgyzstan", countryval: "KG" },
    { countryname: "Lao People's Democratic Republic", countryval: "LA" },
    { countryname: "Latvia", countryval: "LV" },
    { countryname: "Lebanon", countryval: "LB" },
    { countryname: "Lesotho", countryval: "LS" },
    { countryname: "Liberia", countryval: "LR" },
    { countryname: "Libya", countryval: "LY" },
    { countryname: "Liechtenstein", countryval: "LI" },
    { countryname: "Lithuania", countryval: "LT" },
    { countryname: "Luxembourg", countryval: "LU" },
    { countryname: "Macao (澳門)", countryval: "MO" },
    { countryname: "Madagascar", countryval: "MG" },
    { countryname: "Malawi", countryval: "MW" },
    { countryname: "Malaysia", countryval: "MY" },
    { countryname: "Maldives", countryval: "MV" },
    { countryname: "Mali", countryval: "ML" },
    { countryname: "Malta", countryval: "MT" },
    { countryname: "Marshall Islands", countryval: "MH" },
    { countryname: "Martinique", countryval: "MQ" },
    { countryname: "Mauritania", countryval: "MR" },
    { countryname: "Mauritius", countryval: "MU" },
    { countryname: "Mayotte", countryval: "YT" },
    { countryname: "Mexico", countryval: "MX" },
    { countryname: "Micronesia", countryval: "FM" },
    { countryname: "Moldova", countryval: "MD" },
    { countryname: "Monaco", countryval: "MC" },
    { countryname: "Mongolia", countryval: "MN" },
    { countryname: "Montenegro", countryval: "ME" },
    { countryname: "Montserrat", countryval: "MS" },
    { countryname: "Morocco", countryval: "MA" },
    { countryname: "Mozambique", countryval: "MZ" },
    { countryname: "Myanmar", countryval: "MM" },
    { countryname: "Namibia", countryval: "NA" },
    { countryname: "Nauru", countryval: "NR" },
    { countryname: "Nepal", countryval: "NP" },
    { countryname: "Netherlands", countryval: "NL" },
    { countryname: "New Caledonia", countryval: "NC" },
    { countryname: "New Zealand", countryval: "NZ" },
    { countryname: "Nicaragua", countryval: "NI" },
    { countryname: "Niger", countryval: "NE" },
    { countryname: "Nigeria", countryval: "NG" },
    { countryname: "Niue", countryval: "NU" },
    { countryname: "Norfolk Island", countryval: "NF" },
    { countryname: "North Macedonia", countryval: "MK" },
    { countryname: "Northern Mariana Islands", countryval: "MP" },
    { countryname: "Norway", countryval: "NO" },
    { countryname: "Oman", countryval: "OM" },
    { countryname: "Pakistan", countryval: "PK" },
    { countryname: "Palau", countryval: "PW" },
    { countryname: "Palestine", countryval: "PS" },
    { countryname: "Panama", countryval: "PA" },
    { countryname: "Papua New Guinea", countryval: "PG" },
    { countryname: "Paraguay", countryval: "PY" },
    { countryname: "Peru", countryval: "PE" },
    { countryname: "Philippines", countryval: "PH" },
    { countryname: "Pitcairn", countryval: "PN" },
    { countryname: "Poland", countryval: "PL" },
    { countryname: "Portugal", countryval: "PT" },
    { countryname: "Puerto Rico", countryval: "PR" },
    { countryname: "Qatar", countryval: "QA" },
    { countryname: "Réunion", countryval: "RE" },
    { countryname: "Romania", countryval: "RO" },
    { countryname: "Russia", countryval: "RU" },
    { countryname: "Rwanda", countryval: "RW" },
    { countryname: "Saint Barthélemy", countryval: "BL" },
    { countryname: "Saint Helena", countryval: "SH" },
    { countryname: "Saint Kitts and Nevis", countryval: "KN" },
    { countryname: "Saint Lucia", countryval: "LC" },
    { countryname: "Saint Martin", countryval: "MF" },
    { countryname: "Saint Pierre and Miquelon", countryval: "PM" },
    { countryname: "Saint Vincent and the Grenadines", countryval: "VC" },
    { countryname: "Samoa", countryval: "WS" },
    { countryname: "San Marino", countryval: "SM" },
    { countryname: "Sao Tome and Principe", countryval: "ST" },
    { countryname: "Saudi Arabia", countryval: "SA" },
    { countryname: "Senegal", countryval: "SN" },
    { countryname: "Serbia", countryval: "RS" },
    { countryname: "Seychelles", countryval: "SC" },
    { countryname: "Sierra Leone", countryval: "SL" },
    { countryname: "Singapore", countryval: "SG" },
    { countryname: "Sint Maarten", countryval: "SX" },
    { countryname: "Slovakia", countryval: "SK" },
    { countryname: "Slovenia", countryval: "SI" },
    { countryname: "Solomon Islands", countryval: "SB" },
    { countryname: "Somalia", countryval: "SO" },
    { countryname: "South Africa", countryval: "ZA" },
    { countryname: "South Georgia and the South Sandwich Islands", countryval: "GS" },
    { countryname: "South Sudan", countryval: "SS" },
    { countryname: "Spain", countryval: "ES" },
    { countryname: "Sri Lanka", countryval: "LK" },
    { countryname: "Sudan", countryval: "SD" },
    { countryname: "Suriname", countryval: "SR" },
    { countryname: "Svalbard and Jan Mayen", countryval: "SJ" },
    { countryname: "Sweden", countryval: "SE" },
    { countryname: "Switzerland", countryval: "CH" },
    { countryname: "Syrian Arab Republic", countryval: "SY" },
    { countryname: "Taiwan (台灣)", countryval: "TW" },
    { countryname: "Tajikistan", countryval: "TJ" },
    { countryname: "Tanzania", countryval: "TZ" },
    { countryname: "Thailand", countryval: "TH" },
    { countryname: "Timor-Leste", countryval: "TL" },
    { countryname: "Togo", countryval: "TG" },
    { countryname: "Tokelau", countryval: "TK" },
    { countryname: "Tonga", countryval: "TO" },
    { countryname: "Trinidad and Tobago", countryval: "TT" },
    { countryname: "Tunisia", countryval: "TN" },
    { countryname: "Turkey", countryval: "TR" },
    { countryname: "Turkmenistan", countryval: "TM" },
    { countryname: "Turks and Caicos Islands", countryval: "TC" },
    { countryname: "Tuvalu", countryval: "TV" },
    { countryname: "Uganda", countryval: "UG" },
    { countryname: "Ukraine", countryval: "UA" },
    { countryname: "United Arab Emirates", countryval: "AE" },
    { countryname: "United Kingdom", countryval: "GB" },
    { countryname: "United States", countryval: "US" },
    { countryname: "Uruguay", countryval: "UY" },
    { countryname: "Uzbekistan", countryval: "UZ" },
    { countryname: "Vanuatu", countryval: "VU" },
    { countryname: "Venezuela", countryval: "VE" },
    { countryname: "Viet Nam (Việt Nam)", countryval: "VN" },
    { countryname: "Wallis and Futuna", countryval: "WF" },
    { countryname: "Western Sahara", countryval: "EH" },
    { countryname: "Yemen", countryval: "YE" },
    { countryname: "Zambia", countryval: "ZM" },
    { countryname: "Zimbabwe", countryval: "ZW" }
  ],
    ...
    // boolean to show if the song is currently playing or not
    ...
    playlist: [],
    // id of currentTrackPlaying brought in state to persist
  ...
  mutations: {
    ...
    updateSlideBarBackground(state, currentSlideBar) {
      ...
      const defaultColor = '#00EEFF' // light blue default slidebar color
      ...
      if (isMobileScreen) {
        ...
        const hoverColor = '#FFFF00'; // yellow hover color
        const gradient = `linear-gradient(to right, ${defaultColor} ${progress}%, #ffffff ${progress}%)`;
    ...
    // used for Media Session API
    updateMetadata(state) {
      var current_track_title = ''
      var img = ''
        if (!state.currentTrackPlaying) {
          current_track_title = state.playlist[0].title
          img = state.playlist[0].get_cover_art
        }
        else {
          current_track_title = state.playlist.find(item => item.id === state.currentTrackPlaying).title
          img = state.playlist.find(item => item.id === state.currentTrackPlaying).get_cover_art
        }
        ...
        if (navigator && navigator.mediaSession) {
          navigator.mediaSession.metadata = new MediaMetadata({
            ...
            artist: 'Sheriff Crandy',
            artwork: [{ src: img, sizes: '512x512', type: 'image/jpg' }]
          });
        }
    },
    ...
    populateShufflePlaylist(state) {
      ...
      // if there are only 2 or less songs in the playlist, can't shuffle. return
    ...
    removeToken(state) {
      state.profile_pic_background_img = ''
